...
The site can be published at [github.com/aryanxk02/lonboard-examples](https://github.com/aryanxk02/lonboard-examples). For GitHub Pages, publish the repository root (or use a Pages workflow) so the `docs/` site and `examples/` source/media paths are deployed together. Voilà still needs a Python-capable host; GitHub Pages alone cannot execute notebooks.
